...
import Vendor_Dashboard_content from './Vendor_Dashboard_content';
...
import {
    FiHome, FiBriefcase, FiCalendar, FiDollarSign,
    FiStar, FiSettings, FiLogOut, FiSearch,
...
const Vendor_Dashboard = () => {
    ...
    const menuItems = useMemo(() => [
        ...
        { icon: <FiBriefcase />, text: 'My Services', key: 'services' },
        { icon: <FiCalendar />, text: 'Bookings', key: 'bookings' },
        { icon: <FiCalendar />, text: 'Calendar', key: 'calendar' },
        { icon: <FiStar />, text: 'Reviews', key: 'reviews' },
        { icon: <FiDollarSign />, text: 'Earnings', key: 'earnings' },
        { icon: <FiSettings />, text: 'Settings', key: 'settings' }
    ], []);

    const renderContent = useCallback(() => {
        switch (selectedMenu) {
            case 'dashboard': return <Vendor_Dashboard_content />;
            // case 'services': return <VendorServices />;
            // case 'bookings': return <VendorBookings />;
            ...
            default: return <Vendor_Dashboard_content />;
        }
    }, [selectedMenu]);
            ...
            <div className={`user-panel-overlay ${showUserPanel ? 'active' : ''}`} onClick={() => setShowUserPanel(false)}>
                <div className="user-panel" onClick={e => e.stopPropagation()}>
                    ...
                    <div className="user-avatar-container">
                        ...
                        <div className="user-role-badge">Vendor</div>
                    </div>
                        ...
                        <div className="details-section">
                            ...
                            <div className="detail-item">
                                ...
                                <div>
                                    ...
                                    <span className="detail-value">
                                        {user.service_area || 'Not provided'}
                                    </span>
                                </div>
                            </div>
                        </div>
