...
const EventManagement = () => {
    ...
    const handleExport = () => {
        const headers = [
            'Event Name', 'Type', 'Description', 'Start', 'End', 'Location', 'Venue Name',
            'Address', 'City', 'State', 'Country', 'Postal Code', 'Budget', 'Theme', 'Notes', 'Status'
        ];
    ...
    return (
        <div className="event-content">
            <h2 data-aos="fade-right">Event Management</h2>
            {alert.message && (
                <Alert
                    type={alert.type}
            ...
            {!showCreateForm && (
                <>
                    <div className="create-button-container" data-aos="fade-right">
                        ...
                        <button onClick={handleExport} className="create-btn" style={{ marginLeft: '10px' }}>Export CSV</button>
                    </div>
